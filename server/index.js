...
app.get('/items', function (req, res) {
  ...
  .then(res => {
    console.log(res);
    var restaurantArr = res.businesses;
    console.log('rating: ', restaurantArr[0].rating);
  })
  .catch(err => {
    console.log(err);
  })
  ...
  //   var url = `https://api.yelp.com/v3/businesses/search?term=${restaurant}&location=San Francisco`;
  //   var otherPram = {
  //       // mode: "cors", // no-cors, cors, *same-origin
  //       // cache: "no-cache", // *default, no-cache, reload, force-cache, only-if-cached
  //       // credentials: "same-origin", // include, *same-origin, omit
  ...
  //   .then(data => {
  //     //console.log(data);
  //     var restaurantArr = data.businesses;
  //     console.log('rating: ', restaurantArr[0].rating);
  //   })
  //   .catch(err => {
  //     console.log(err);
